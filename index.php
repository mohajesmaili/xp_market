                        ...
                        echo '<div class="span4">
                            <div class="product">
                                <div class="product-img featured">
                                    <div class="picture">
                                        <img src="images/product/'.$row["id"].'.png" alt="" width="518" height="358" />
                                        <div class="img-overlay">
                                            <a href="product.php?productid='.$row["id"].'&categoryid='.$row["categoryp"].'" class="btn more btn-primary">توضیحات بیشتر</a>';
    	            	                    if($_SESSION["user"]==true) {
    	            	        		    echo '<a  href="inc/add_basket.php?product_id='.$row["id"].'" class="btn buy btn-danger">خرید</a>';
                                            }
                                      echo'</div>
                                    </div>
                                </div>
    ...
    <div class="most-popular blocks-spacer">
    	<div class="container">
    	    ...
    	    <div class="row">
    	    	<div class="span12">
    	    	    <div class="main-titles lined">
    	                <h2 class="title">محصولات تصادفی فروشگاه</h2>
    	            </div>
    	    	</div>
    	    </div> <!-- /title -->
	    	...
	    	<div class="row popup-products">
                ...
                '<div class="span3">
                    <div class="product">
                        <div class="product-img">
                            <div class="picture">
                                <img src="images/product/'.$row["id"].'.png" alt="" width="540" height="412" />
                                <div class="img-overlay">
                                    <a href="product.php?productid='.$row["id"].'&categoryid='.$row["categoryp"].'" class="btn more btn-primary">توضیحات بیشتر</a>';
                                    if($_SESSION["user"]==true) {
                                        echo '<a href="inc/add_basket.php?product_id=' . $row["id"] . '" class="btn buy btn-danger">اضافه به سبد خرید</a>';
    		        ...
    		        <div class="carouFredSel" data-nav="tweets" data-autoplay="false">
                        ...
                        <div class="slide">
                            ...
                            echo
                        		'<div class="span6">
                        		    <div class="news-item">
                        		        <div class="published">'.$row["date"].'</div>
                        		        <h6><a href="blog-single.php?newsid='.$row["id"].'">'.$row["subject"].'</a></h6>
