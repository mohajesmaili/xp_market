...
var newpass = document.forms["form"]["new-pass"].value;
var rnpass = document.forms["form"]["rn-pass"].value;
var captcha = document.forms["form"]["captcha"].value;
if (pass == null || pass == ""){
    document.getElementById('pass').style="border:1px solid #D40000";
  return false;
  }
  else if (newpass == null || newpass == ""){
    document.getElementById('new-pass').style="border:1px solid #D40000";
  return false;
  }
  else if (rnpass == null || rnpass == ""){
  document.getElementById('rn-pass').style="border:1px solid #D40000";
  return false;
...
function CheckEmpty(){
  ...
  rnpass=document.getElementById('rn-pass').value;
  captcha=document.getElementById('captcha').value; 
    ...
    if(newpass === ''){
        ...
        document.getElementById('new-pass').style="";
    }
  if(rnpass === ''){
        document.getElementById('rn-pass').style="border:1px solid #D40000";
        return false;
        ...
        document.getElementById('rn-pass').style="";
    }  
    if(captcha === ''){
        document.getElementById('captcha').style="border:1px solid #D40000";
        return false;
      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-left"></i>ویرایش پسورد</h4>
