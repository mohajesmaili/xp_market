...
<html lang="en">
  <head>
    ...
    <title>Mr.Developer | show_tutorails</title>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="show-tutorails.php">نمایش دوره ها</a></li>
                  ...
                  <div class="col-md-12" style="margin-top: 20px;">
                      <div class="content-panel">
                          <h4></i>نمایش دوره ها</h4><hr><table class="table table-striped table-advance table-hover">
                              ...
                              <?php                 
                                require('connect.php');
                                $show_tutorails=("SELECT * FROM `tutorails`");
                                $result=mysqli_query($sql,$show_tutorails);
                                ...
                                echo'<form method="post" action="inc/dltutorails.php" id="frm"   onSubmit="return dl()">
                                      ...
                                      <td>'.$row["title"].'</td>
                                      <td>'.$row["date"].'</td>
                                      <td><img src="../assets/img/tutorails_image/'.$row["id"].'.jpg" width="60" height="60" style="border-radius:8px;"/></td>
                                      <td>
									                    <a href="edit-tutorails.php?tutorailsid='.$row['id'].'" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
