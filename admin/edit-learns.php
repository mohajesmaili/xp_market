...
<html lang="en">
  <head>
    ...
    <title>Mr.Developer | edit_learns</title>
      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-left"></i>ویرایش آموزش </h4>
                      <form class="form-horizontal style-form" method="post" action="inc/edit-learns.php" name="form" onsubmit="return validateForm();" enctype="multipart/form-data">
                        <?php
                          $id=$_REQUEST['learnid'];
                          ...
                          $edit_tutorails=("SELECT * FROM `tutorails_learn` where id='$id'");
