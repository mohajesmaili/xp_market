...
<html lang="en">
  <head>
    ...
    <title>XP_Market | ویرایش دسته</title>
      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="inc/edit-categoryp.php" name="form" onsubmit="return validateForm();" enctype="multipart/form-data">
                        <?php
                          $id=$_REQUEST['categoryp_id'];
                          ...
                          $edit_category=("SELECT * FROM `categoryp` where id='$id'");
