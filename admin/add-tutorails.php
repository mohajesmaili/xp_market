      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-left"></i> شروع جدید دوره</h4>
                      <form class="form-horizontal style-form" method="post" action="inc/add-tutorails.php" name="form" onsubmit="return validateForm();" enctype="multipart/form-data">   
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">تیتر:</label>
                              <div class="col-sm-10" style="margin-right: -100px;">
                                  <input id="title" name="title" class="form-control round-form" type="text" placeholder="تیتر دوره" onblur="CheckEmpty();">
                              </div>
                          </div>  
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">ادمین:</label>
                              <div class="col-sm-10" style="margin-right: -100px;">
                                  <select id="admin" name="admin" class="form-control round-form" onblur="CheckEmpty();">
                                    <?php 
                                    require('connect.php');
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">تاریخ:</label>
                              <div class="col-sm-10" style="margin-right: -100px;">
