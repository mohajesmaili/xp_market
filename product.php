                    ...
                    <div class="tab-content">
                        ...
                        <div class="fade tab-pane" id="tab-3">
                            <section id="comments" class="comments-container">
                                ...
                                <?php
                                if($_SESSION["user"]==true) {
                                    echo '<form id="commentform" name="commentform" method="POST" action="inc/send_commentp.php?userid='.$_SESSION["user_id"].'&productid='.$id.'&categoryid='.$category.'" class="form form-inline form-comments" onsubmit="return validateForm();">
                                    <p class="push-down-20">
                                        <textarea class="input-block-level" tabindex="4" rows="7" cols="70" id="comment" name="comment" placeholder="نظرتان را در اینجا بنویسید ..." required></textarea>
                                    </p>
                                    <p class="push-down-20">
